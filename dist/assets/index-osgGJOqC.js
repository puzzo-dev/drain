const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/index-Bm2zL3D_.js',
      'assets/index-Bw5SLssp.js',
      'assets/index-CTcTF-pb.css',
    ]),
) => i.map((i) => d[i]);
import { p, s as h, f as R, _ as V } from './index-Bw5SLssp.js';
const n = p({
  ...
  x = {
    ...
    replace(e) {
      n.history.length > 1 &&
        ((n.history[n.history.length - 1] = e), (n.view = e));
    },
    goBack() {
  ...
  r = {
    ...
    isAndroid() {
      return (
        r.isMobile() && navigator.userAgent.toLowerCase().includes('android')
      );
    },
    isIos() {
    ...
    setModalVersionInStorage() {
      try {
        typeof localStorage < 'u' &&
          localStorage.setItem(r.WCM_VERSION, '2.6.2');
      } catch {
...
var K = Object.defineProperty,
  ...
  D = (e, t, s) =>
    t in e
      ? K(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (e[t] = s),
  q = (e, t) => {
    for (var s in t || (t = {})) z.call(t, s) && D(e, s, t[s]);
    if (j) for (var s of j(t)) J.call(t, s) && D(e, s, t[s]);
    return e;
  };
...
async function W(e, t) {
  const s = q({ sdkType: O, sdkVersion: A }, t),
    o = new URL(e, E);
  return (
...
var F = Object.defineProperty,
  ...
  _ = (e, t, s) =>
    t in e
      ...
      : (e[t] = s),
  X = (e, t) => {
    for (var s in t || (t = {})) G.call(t, s) && _(e, s, t[s]);
    if (k) for (var s of k(t)) Q.call(t, s) && _(e, s, t[s]);
    return e;
  };
const S = r.isMobile(),
  u = p({
    ...
    async getRecomendedWallets() {
      ...
      if (r.isArray(e)) {
        const s = { recommendedIds: e.join(',') },
          { listings: o } = await m.getAllListings(s),
          i = Object.values(o);
        (i.sort((l, b) => {
          const v = e.indexOf(l.id),
            C = e.indexOf(b.id);
          return v - C;
        }),
          (u.recomendedWallets = i));
      } else {
        const { chains: s, isAuth: o } = c.state,
          i = s == null ? void 0 : s.join(','),
          l = r.isArray(t),
          b = {
            page: 1,
          ...
          { listings: v } = S
            ? await m.getMobileListings(b)
            : await m.getDesktopListings(b);
        u.recomendedWallets = Object.values(v);
      }
...
var Y = Object.defineProperty,
  ...
  T = (e, t, s) =>
    t in e
      ...
      : (e[t] = s),
  te = (e, t) => {
    for (var s in t || (t = {})) Z.call(t, s) && T(e, s, t[s]);
    if (N) for (var s of N(t)) ee.call(t, s) && T(e, s, t[s]);
    return e;
  };
function se() {
  return (
...
const y = p({ themeMode: se() ? 'dark' : 'light' }),
  P = {
    state: y,
    subscribe(e) {
      return h(y, () => e(y));
    ...
    setThemeConfig(e) {
      ...
      (t && (y.themeMode = t), s && (y.themeVariables = te({}, s)));
    },
  },
  g = p({ open: !1, message: '', variant: 'success' }),
  re = {
    state: g,
    subscribe(e) {
      return h(g, () => e(g));
...
class oe {
  constructor(t) {
    ((this.openModal = L.open),
      (this.closeModal = L.close),
      (this.subscribeModal = L.subscribe),
      (this.setTheme = P.setThemeConfig),
      P.setThemeConfig(t),
      f.setConfig(t),
      this.initUi());
  }
  async initUi() {
    if (typeof window < 'u') {
      await V(() => import('./index-Bm2zL3D_.js'), __vite__mapDeps([0, 1, 2]));
...
const ie = Object.freeze(
  Object.defineProperty(
    { __proto__: null, WalletConnectModal: oe },
    Symbol.toStringTag,
    { value: 'Module' },
  ),
);
...
//# sourceMappingURL=index-osgGJOqC.js.map
