...
const Gt =
  ...
  Ee = Array.from({ length: 256 }, (e, n) => n.toString(16).padStart(2, '0'));
function ut(e) {
  if ((Zt(e), Gt)) return e.toHex();
  let n = '';
  for (let t = 0; t < e.length; t++) n += Ee[e[t]];
  return n;
}
...
function wt(e) {
  if (typeof e != 'string')
    throw new Error('hex string expected, got ' + typeof e);
  if (Gt) return Uint8Array.fromHex(e);
  const n = e.length,
    t = n / 2;
  if (n % 2)
  ...
  for (let i = 0, s = 0; i < t; i++, s += 2) {
    const c = kt(e.charCodeAt(s)),
      u = kt(e.charCodeAt(s + 1));
    if (c === void 0 || u === void 0) {
      const o = e[s] + e[s + 1];
      throw new Error(
        'hex string expected, got non-hex character "' + o + '" at index ' + s,
      );
    }
    r[i] = c * 16 + u;
  }
...
function P(e, n, t) {
  ...
  else if (lt(n)) r = Uint8Array.from(n);
...
const mt = (e) => (Ot << BigInt(e)) - Ot,
  Bt = (e) => new Uint8Array(e),
  Ct = (e) => Uint8Array.from(e);
function ve(e, n, t) {
...
function pt(e, n, t = {}) {
  const r = (i, s, c) => {
    ...
    if (!(c && o === void 0) && !u(o, e))
      throw new Error(
        'param ' + String(i) + ' is invalid. Expected ' + s + ', got ' + o,
      );
  };
...
class Ft extends le {
  constructor(n, t) {
    (super(), (this.finished = !1), (this.destroyed = !1), de(n));
    const r = he(t);
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const j =
    BigInt(0),
  C = BigInt(1),
  tt = BigInt(2),
  Se = BigInt(3),
...
function qt(e, n) {
  ...
  if (n <= j) throw new Error('invert: expected positive modulus, got ' + n);
  let t = M(e, n),
    r = n,
    i = j,
    s = C;
  ...
  if (r !== C) throw new Error('invert: does not exist');
  return M(i, n);
}
function ne(e, n) {
  const t = (e.ORDER + C) / Jt,
    r = e.pow(n, t);
  if (!e.eql(e.sqr(r), n)) throw new Error('Cannot find square root');
  return r;
}
function Ae(e, n) {
  const t = (e.ORDER - te) / ee,
    r = e.mul(n, tt),
    i = e.pow(r, t),
    s = e.mul(n, i),
    c = e.mul(e.mul(s, tt), i),
    u = e.mul(s, e.sub(c, e.ONE));
  if (!e.eql(e.sqr(u), n)) throw new Error('Cannot find square root');
  return u;
}
function Ie(e) {
  ...
  return function (o, d) {
    if (o.is0(d)) return d;
    if (Mt(o, d) !== 1) throw new Error('Cannot find square root');
    let m = t,
      A = o.mul(o.ONE, s),
      N = o.pow(d, n),
      R = o.pow(d, c);
    for (; !o.eql(N, o.ONE); ) {
      if (o.is0(N)) return o.ZERO;
      let z = 1,
        g = o.sqr(N);
      for (; !o.eql(g, o.ONE); )
        if ((z++, (g = o.sqr(g)), z === m))
          throw new Error('Cannot find square root');
      const _ = C << BigInt(m - z - 1),
        Z = o.pow(A, _);
...
function He(e, n, t) {
  ...
  let r = e.ONE,
    i = n;
  for (; t > j; ) (t & C && (r = e.mul(r, i)), (i = e.sqr(i)), (t >>= C));
  return r;
}
function re(e, n, t = !1) {
  const r = new Array(n.length).fill(t ? e.ZERO : void 0),
    i = n.reduce(
      (c, u, o) => (e.is0(u) ? c : ((r[o] = c), e.mul(c, u))),
      e.ONE,
    ),
    s = e.inv(i);
  return (
    n.reduceRight(
      (c, u, o) => (e.is0(u) ? c : ((r[o] = e.mul(c, r[o])), e.mul(c, u))),
      s,
    ),
    r
  );
...
function Ut(e, n, t = !1, r = {}) {
  ...
  const u = Object.freeze({
    ...
    fromBytes: (o) => {
      if (o.length !== s)
        throw new Error(
          'Field.fromBytes: expected ' + s + ' bytes, got ' + o.length,
        );
      return t ? Wt(o) : et(o);
    },
...
function Ze(e, n) {
  return {
    ...
    unsafeLadder(t, r, i = e.ZERO) {
      let s = t;
      for (; r > jt; ) (r & Ht && (i = i.add(s)), (s = s.double()), (r >>= Ht));
      return i;
    },
    precomputeWindow(t, r) {
      const { windows: i, windowSize: s } = xt(r, n),
        c = [];
      let u = t,
        o = u;
      for (let d = 0; d < i; d++) {
        ((o = u), c.push(o));
        for (let m = 1; m < s; m++) ((o = o.add(u)), c.push(o));
        u = o.double();
      }
      return c;
    },
    ...
    getPrecomputes(t, r, i) {
      let s = St.get(r);
      return (
        s || ((s = this.precomputeWindow(r, t)), t !== 1 && St.set(r, i(s))),
        s
      );
    },
    wNAFCached(t, r, i) {
    ...
    wNAFCachedUnsafe(t, r, i, s) {
      ...
      return c === 1
        ...
        : this.wNAFUnsafe(c, this.getPrecomputes(c, t, i), r, s);
    },
    setWindowSize(t, r) {
...
function Te(e, n, t, r) {
  ...
  const d = mt(o),
    m = new Array(Number(d) + 1).fill(c),
    A = Math.floor((n.BITS - 1) / o) * o;
  let N = c;
  for (let R = A; R >= 0; R -= o) {
    m.fill(c);
    for (let g = 0; g < s; g++) {
      const _ = r[g],
        Z = Number((_ >> BigInt(R)) & d);
      m[Z] = m[Z].add(t[g]);
    }
    let z = c;
    for (let g = m.length - 1, _ = c; g > 0; g--)
      ((_ = _.add(m[g])), (z = z.add(_)));
    if (((N = N.add(z)), R !== 0)) for (let g = 0; g < o; g++) N = N.double();
  }
  return N;
}
function ae(e) {
  return (
    ...
    Object.freeze({ ...oe(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
  );
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function Pt(
  e,
) {
  (e.lowS !== void 0 && at('lowS', e.lowS),
    e.prehash !== void 0 && at('prehash', e.prehash));
}
function Ue(e) {
  const n = ae(e);
  pt(
  ...
  if (t) {
    if (!r.eql(i, r.ZERO)) throw new Error('invalid endo: CURVE.a must be 0');
    if (
      typeof t != 'object' ||
...
const W = {
  ...
  _tlv: {
    ...
    decode(e, n) {
      ...
      if (!s) c = i;
        ...
        for (const m of d) c = (c << 8) | m;
        if (((r += o), c < 128))
          throw new t('tlv.decode(long): not minimal encoding');
      }
      const u = n.subarray(r, r + c);
      if (u.length !== c) throw new t('tlv.decode: wrong value length');
  ...
  _int: {
    encode(e) {
      const { Err: n } = W;
      if (e < X) throw new n('integer: negative integers are not allowed');
      let t = ht(e);
  ...
  toSig(e) {
    const { Err: n, _int: t, _tlv: r } = W,
      i = P('signature', e),
      { v: s, l: c } = r.decode(48, i);
    if (c.length) throw new n('invalid signature: left bytes after parsing');
    const { v: u, l: o } = r.decode(2, s),
      { v: d, l: m } = r.decode(2, o);
    if (m.length) throw new n('invalid signature: left bytes after parsing');
    return { r: t.decode(u), s: t.decode(d) };
  },
  hexFromSig(e) {
    const { _tlv: n, _int: t } = W,
...
function Ce(e) {
  const n = Ue(e),
    ...
    s =
      n.fromBytes ||
      ((x) => {
        const f = x.subarray(1),
          h = t.fromBytes(f.subarray(0, t.BYTES)),
          p = t.fromBytes(f.subarray(t.BYTES, 2 * t.BYTES));
        return { x: h, y: p };
      });
  function c(x) {
    const { a: f, b: h } = n,
  ...
  if (!u(n.Gx, n.Gy)) throw new Error('bad curve params: generator point');
  const o = t.mul(t.pow(n.a, Nt), ke),
    d = t.mul(t.sqr(n.b), BigInt(27));
  if (t.is0(t.add(o, d))) throw new Error('bad curve params: a or b');
  function m(x) {
    return Tt(x, T, n.n);
  }
  function A(x) {
    ...
    let O;
    try {
      O = typeof x == 'bigint' ? x : et(P('private key', x, h));
    } catch {
      throw new Error(
        'invalid private key, expected hex or ' + h + ' bytes, got ' + typeof x,
      );
    }
    return (p && (O = M(O, B)), it('private key', O, T, B), O);
  }
  function N(x) {
    if (!(x instanceof g)) throw new Error('ProjectivePoint expected');
  }
  const R = Vt((x, f) => {
      const { px: h, py: p, pz: B } = x;
      if (t.eql(B, t.ONE)) return { x: h, y: p };
      const O = x.is0();
      f == null && (f = O ? t.ONE : t.inv(B));
      const H = t.mul(h, f),
        q = t.mul(p, f),
        y = t.mul(B, f);
      if (O) return { x: t.ZERO, y: t.ZERO };
      if (!t.eql(y, t.ONE)) throw new Error('invZ was invalid');
      return { x: H, y: q };
    }),
    z = Vt((x) => {
      if (x.is0()) {
        if (n.allowInfinityPoint && !t.is0(x.py)) return;
        throw new Error('bad point: ZERO');
      }
      const { x: f, y: h } = x.toAffine();
      if (!t.isValid(f) || !t.isValid(h))
        throw new Error('bad point: x or y not FE');
      if (!u(f, h)) throw new Error('bad point: equation left != right');
      if (!x.isTorsionFree())
  ...
  class g {
    constructor(f, h, p) {
      if (f == null || !t.isValid(f)) throw new Error('x required');
      if (h == null || !t.isValid(h) || t.is0(h)) throw new Error('y required');
    ...
    static fromAffine(f) {
      ...
      if (f instanceof g) throw new Error('projective point not allowed');
    ...
    static fromHex(f) {
      const h = g.fromAffine(s(P('pointHex', f)));
    ...
    equals(f) {
      N(f);
      const { px: h, py: p, pz: B } = this,
        { px: O, py: H, pz: q } = f,
        y = t.eql(t.mul(h, q), t.mul(O, B)),
        I = t.eql(t.mul(p, q), t.mul(H, B));
      return y && I;
    }
    negate() {
    ...
    multiplyUnsafe(f) {
      ...
      const B = g.ZERO;
      if (f === X) return B;
      if (this.is0() || f === T) return this;
      if (!h || $.hasPrecomputes(this))
        return $.wNAFCachedUnsafe(this, f, g.normalizeZ);
      let { k1neg: O, k1: H, k2neg: q, k2: y } = h.splitScalar(f),
        I = B,
        b = B,
        U = this;
      for (; H > X || y > X; )
      ...
      return (
        O && (I = I.negate()),
        q && (b = b.negate()),
        (b = new g(t.mul(b.px, h.beta), b.py, b.pz)),
        I.add(b)
      );
    }
    multiply(f) {
      ...
      if (h) {
        ...
        let { p: b, f: U } = this.wNAF(q),
          { p: l, f: a } = this.wNAF(I);
        ((b = $.constTimeNegate(H, b)),
          (l = $.constTimeNegate(y, l)),
          (l = new g(t.mul(l.px, h.beta), l.py, l.pz)),
          (B = b.add(l)),
          (O = U.add(a)));
      } else {
    ...
    clearCofactor() {
      ...
      return f === T ? this : h ? h(g, this) : this.multiplyUnsafe(n.h);
    }
    toRawBytes(f = !0) {
  ...
  ((g.BASE = new g(n.Gx, n.Gy, t.ONE)),
    (g.ZERO = new g(t.ZERO, t.ONE, t.ZERO)));
  const { endo: _, nBitLength: Z } = n,
    $ = Ze(g, _ ? Math.ceil(Z / 2) : Z);
  return {
    CURVE: n,
    ProjectivePoint: g,
...
function Me(e) {
  const n = Ve(e),
    { Fp: t, n: r, nByteLength: i, nBitLength: s } = n,
    c = t.BYTES + 1,
    u = 2 * t.BYTES + 1;
  function o(l) {
    return M(l, r);
  ...
  const {
    ...
    toBytes(l, a, w) {
      ...
      return (
        at('isCompressed', w),
        w
          ? v(Uint8Array.from([a.hasEvenY() ? 2 : 3]), E)
          : v(Uint8Array.from([4]), E, t.toBytes(S.y))
      );
    },
    fromBytes(l) {
      const a = l.length,
      ...
      if (a === c && (w === 2 || w === 3)) {
        const E = et(S);
        if (!Tt(E, T, t.ORDER)) throw new Error('Point is not on curve');
        const v = N(E);
        let L;
        try {
          L = t.sqrt(v);
        } catch (K) {
          const V = K instanceof Error ? ': ' + K.message : '';
          throw new Error('Point is not on curve' + V);
        }
        const k = (L & T) === T;
        return (((w & 1) === 1) !== k && (L = t.neg(L)), { x: E, y: L });
      } else if (a === u && w === 4) {
        const E = t.fromBytes(S.subarray(0, t.BYTES)),
          v = t.fromBytes(S.subarray(t.BYTES, 2 * t.BYTES));
        return { x: E, y: v };
      } else {
        const E = c,
          v = u;
  ...
  class Z {
    ...
    static fromCompact(a) {
      const w = i;
      return (
        (a = P('compactSignature', a, w * 2)),
        new Z(_(a, 0, w), _(a, w, 2 * w))
      );
    }
    static fromDER(a) {
      const { r: w, s: S } = W.toSig(P('DER', a));
      return new Z(w, S);
    }
    assertValidity() {}
    addRecoveryBit(a) {
    ...
    recoverPublicKey(a) {
      ...
      const k = E & 1 ? '03' : '02',
        D = m.fromHex(k + It(L, t.BYTES)),
        K = d(L),
        V = o(-v * K),
        nt = o(S * K),
        F = m.BASE.multiplyAndAddUnsafe(D, V, nt);
  ...
  function f(l) {
    ...
    if (l instanceof m) return !0;
    const w = P('key', l).length,
      S = t.BYTES,
      E = S + 1,
      v = 2 * S + 1;
    if (!(n.allowedPrivateKeyLengths || i === E)) return w === E || w === v;
  }
  function h(l, a, w = !0) {
    if (f(l) === !0) throw new Error('first arg must be private key');
    if (f(a) === !1) throw new Error('second arg must be public key');
  ...
  function q(l, a, w = y) {
    ...
    let { lowS: v, prehash: L, extraEntropy: k } = w;
    (v == null && (v = !0),
      (l = P('msgHash', l)),
      Pt(w),
      L && (l = P('prehashed msgHash', S(l))));
    const D = B(l),
      K = A(a),
      V = [H(K), H(D)];
    if (k != null && k !== !1) {
      const Q = k === !0 ? E(t.BYTES) : k;
      V.push(P('extraEntropy', Q));
    }
    const nt = gt(...V),
      F = D;
    function yt(Q) {
      ...
      if (!R(rt)) return;
      const bt = d(rt),
        st = m.BASE.multiply(rt).toAffine(),
        J = o(st.x);
      if (J === X) return;
      const ct = o(bt * o(F + J * K));
      if (ct === X) return;
      let ft = (st.x === J ? 0 : 2) | Number(st.y & T),
        ot = ct;
      return (v && z(ct) && ((ot = g(ct)), (ft ^= 1)), new Z(J, ot, ft));
    }
    return { seed: nt, k2sig: yt };
  }
  const y = { lowS: n.lowS, prehash: !1 },
    I = { lowS: n.lowS, prehash: !1 };
  function b(l, a, w = y) {
    const { seed: S, k2sig: E } = q(l, a, w),
      v = n;
    return ve(v.hash.outputLen, v.nByteLength, v.hmac)(S, E);
  }
  m.BASE._setWindowSize(8);
  function U(l, a, w, S = I) {
    var ft;
    const E = l;
    ((a = P('msgHash', a)), (w = P('publicKey', w)));
    const { lowS: v, prehash: L, format: k } = S;
    if ((Pt(S), 'strict' in S))
      throw new Error('options.strict was renamed to lowS');
    if (k !== void 0 && k !== 'compact' && k !== 'der')
      throw new Error('format must be compact or der');
    const D = typeof E == 'string' || lt(E),
      K =
        !D &&
        !k &&
        typeof E == 'object' &&
    ...
    let V, nt;
    try {
      if ((K && (V = new Z(E.r, E.s)), D)) {
        try {
          k !== 'compact' && (V = Z.fromDER(E));
        } catch (ot) {
          if (!(ot instanceof W.Err)) throw ot;
        }
        !V && k !== 'der' && (V = Z.fromCompact(E));
      }
      nt = m.fromHex(w);
    } catch {
      return !1;
    }
    if (!V || (v && V.hasHighS())) return !1;
    L && (a = n.hash(a));
    const { r: F, s: yt } = V,
      Q = B(a),
      rt = d(yt),
      ...
      st = o(F * rt),
      J =
        (ft = m.BASE.multiplyAndAddUnsafe(nt, bt, st)) == null
          ? void 0
          : ft.toAffine();
    return J ? o(J.x) === F : !1;
  }
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function je(
  e,
) {
  return { hash: e, hmac: (n, ...t) => Qt(e, n, ye(...t)), randomBytes: pe };
}
function Ye(e, n) {
  const t = (r) => Me({ ...e, ...je(r) });
  return { ...t(n), create: t };
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const ue =
    BigInt(
...
function $e(e) {
  const n = ue,
    ...
    h = (Y(f, r, n) * d) % n,
    p = Y(h, Lt, n);
  if (!Rt.eql(Rt.sqr(p), e)) throw new Error('Cannot find square root');
  return p;
}
const Rt = Ut(ue, void 0, void 0, { sqrt: $e }),
  De = Ye(
    {
      a: Pe,
      b: BigInt(7),
  ...
  We = Object.freeze(
    Object.defineProperty(
      { __proto__: null, secp256k1: De },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  );
export { Ut as F, We as a, Ye as c, De as s };
//# sourceMappingURL=secp256k1-BSnmbGRP.js.map
